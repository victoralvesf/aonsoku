import { SearchQueryOptions } from '@/service/lovedsongs'
...
export async function songsSearchLoved(params: SongSearchParams) {
...
export async function getLovedArtistAllSongs(artistId: string) {
