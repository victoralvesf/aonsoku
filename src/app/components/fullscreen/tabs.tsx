  ...
  return (
    <Tabs defaultValue="queue" className="w-full h-full">
      <TabsList className="w-full bg-muted/50">
        <TabsTrigger value="queue" className="w-full data-[state=active]:bg-background/70">Queue</TabsTrigger>
        <TabsTrigger value="lyrics" className="w-full data-[state=active]:bg-background/70">Lyrics</TabsTrigger>
      </TabsList>
